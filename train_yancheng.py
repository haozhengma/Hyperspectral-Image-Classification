...
from models2.CASANet_light import CASANet
...
def main(args):
    ...
    yancheng_path = r'dataset'
    TrainPatch_HSI, TrainPatch_MSI, Y_train, TestPatch_HSI, TestPatch_MSI, Y_test = load_data(yancheng_path)
    # 训练集
    ...
    model = CASANet(args.num_class)  # CASA
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if oa > best_acc:
            ...
            torch.save(model, os.path.join(args.model_path, '{}_seed0_1017.pth'.format(args.model_name)))
            best_acc = oa
            best_epoch = epoch
